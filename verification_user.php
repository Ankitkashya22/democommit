...
$sql_before_update = "SELECT * FROM `person` WHERE `ID` = '".$user_id."'";
$result = mysqli_query($connection, $sql_before_update) or die("query failed");
$email_otp =  "";
// $mobile_otp = "";
...
if(isset($_POST['submitEmail'])){
    ...
    if($email_otp == $user_email_otp){
        $sql = "UPDATE `person` SET `email_verify_status` = '1' WHERE `ID` = '".$user_id."'";
    ...
    <div class="content"> 
     ...
     <div class="form"> 
      ...
      <div class="inputBox"> 
       ...
       <input type="text" required> <i>VERIFY OTP</i> 
...
<!-- 
      ...
      <div class="links"> <a href="#">Resend OTP</a> <a href="signup.php">Signup</a> 
